...
public final class ItemNiatBinding implements ViewBinding {
  @NonNull
  ...
  private ItemNiatBinding(@NonNull LinearLayout rootView, @NonNull TextView arabic,
  ...
  @NonNull
  public static ItemNiatBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ItemNiatBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.item_niat, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ItemNiatBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemNiatBinding((LinearLayout) rootView, arabic, latin, name, terjemahan);
    }
